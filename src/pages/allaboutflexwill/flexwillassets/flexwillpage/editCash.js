...
import "./editspouse.css"

function SpouseReview({ setToggleState, reviewNext, addAnotherSpouse, spouselist, editSpouseDetail }) {
                                    ...
                                    <div className='submit'>
                                        {
                                            loading ?
                                                ...
                                                <>  {success && (<div className='success'>Spouse list updated successfully</div>)}
                                                    <span type="submit" className='general-btn'>Update</span>
                                                </>
                                        }
                                    </div>
                                </div>
