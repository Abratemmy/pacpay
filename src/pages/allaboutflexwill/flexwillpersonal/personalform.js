...
import { createPersonalinformation, getProduct } from "../../actions/auth.js"
...
function Personalform() {
    ...
    const handleSubmit = (e) => {
        ...
        if (Object.keys(burialError).length > 0) {
            ...
            dispatch(createPersonalinformation(payload, navigate));
            ...
            <Interface>
                <div className="Personal-container">
                    ...
                    <div className={toggleState === 2 ? "PersonalFormcontent active-PersonalFormcontent" : "PersonalFormcontent"}>
                        <SpouseReview setToggleState={spouseBackBtn} reviewNext={reviewNext} addAnotherSpouse={addAnotherSpouse} spouselist={spouselist}
                    ...
                    <div className={toggleState === 3 ? "PersonalFormcontent active-PersonalFormcontent" : "PersonalFormcontent"}>
                        <ChildReview setToggleState={childBackBtn} reviewNext={reviewNext} addAnotherChild={addAnotherChild} childlist={childlist}
