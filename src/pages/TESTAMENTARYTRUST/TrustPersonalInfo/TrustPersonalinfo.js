...
import TrustChildReview from "./trustChildreview.js";
import TrustSpouseReview from "./trustSpousereview"
...
import { createPersonalinformationTrust, getProduct } from "../../actions/auth.js"
import { useDispatch, useSelector } from "react-redux";
import MainModal from "../../../components/mainModal/MainModal";
import { personalModal } from "../../../components/svg/personalPop"

function TrustPersonalinfo() {
    ...
    const editFinancialDetail = (value) => {
        console.log("val", value)
        // let financialGuardian = { value: {} }
        const financialGuardian = value
        setChildren(newchild => ({
            ...newchild,
            financialGuardian
        }))
    ...
    const handleSubmit = (e) => {
        ...
        if (Object.keys(burialError).length > 0) {
            ...
            dispatch(createPersonalinformationTrust(payload, navigate));
            ...
            <Interface>
                <div className="Personal-container">
                        ...
                        toggleState === 2 || toggleState === 3 ? ""
                            : (
                                <div>
                                    <div className="top">
                                        {page === 0 ? (
                                            <span><NavLink to="/rust_personal_landing" className="personal-nav">
                    ...
                    <div className={toggleState === 2 ? "PersonalFormcontent active-PersonalFormcontent" : "PersonalFormcontent"}>
                        <TrustSpouseReview setToggleState={spouseBackBtn} reviewNext={reviewNext} addAnotherSpouse={addAnotherSpouse} spouselist={spouselist}
                    ...
                    <div className={toggleState === 3 ? "PersonalFormcontent active-PersonalFormcontent" : "PersonalFormcontent"}>
                        <TrustChildReview setToggleState={childBackBtn} reviewNext={reviewNext} addAnotherChild={addAnotherChild} childlist={childlist}
                    ...
                    <div className={toggleState === 4 ? "PersonalFormcontent active-PersonalFormcontent" : "PersonalFormcontent"}>
                        <Guardian guardian={guardian} setGuardian={setGuardian} errors={errors} editFinancialDetail={editFinancialDetail} />
...
export default TrustPersonalinfo