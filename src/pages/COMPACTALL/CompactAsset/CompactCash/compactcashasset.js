...
function CompactCashAsset() {
    ...
    return (
        <div>
            <Interface>
                <AssetInterface name="Assets" link="compact_cash_distribute" />
                    ...
                    <div className=''>
                        ...
                        <div className='bloc-design'>
                            <div className="bloc-tabs disable-bloc">
                                <div className={toggleState === 1 ? "tabs active-tabs" : "tabs done  disable"} onClick={() => toggleTab(1)}><span><img src={assetrsa} alt="" /> </span>RSA</div>
                        ...
                        <div className='distributeAssets'>
                            <div className="content-tabs" style={{ marginTop: "40px" }}>
                                ...
                                <div className={toggleState === 2 ? "content active-content" : "content"}>
                                    ...
                                    <div className='button' style={{ textAlign: "right", paddingTop: "60px", marginTop: "30px" }}>
                                        <NavLink to="/compact_realestate_form" className="asset-nav1" style={{ border: "none" }}>
                                            Add Real Estate
                                        </NavLink>
                                    </div>
...
export default CompactCashAsset