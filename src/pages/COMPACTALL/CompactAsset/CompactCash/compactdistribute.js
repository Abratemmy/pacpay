...
function CompactCashDistribute() {
    ...
    return (
        <div className='Assetmain-page'>
            <Interface>
                <AssetInterface name="Distribute Assets" link="compact_cash_form" />
                        ...
                        <div className="personal-modal">
                            <div className="personal-modalContainer">
                                ...
                                <div className="personalmodal-btn">
                                    <NavLink to="/compact_cash_landing" className="first assetModal-nav"
                                    >Yes</NavLink>
                                    <NavLink to="/compact_cash_assets" className="second assetModal-nav"
...
export default CompactCashDistribute