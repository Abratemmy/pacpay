...
function CompactStockDistribute() {
    ...
    return (
        <div className='Assetmain-page'>
            <Interface>
                <AssetInterface name="Distribute Assets" link="compact_stock_form" />
                    ...
                    <div className='new-assetmodal'>
                        <div className="personal-modal">
                            <div className="personal-modalContainer">
                                ...
                                <div className="text">Do you want to upload another stock details? </div>

                                <div className="personalmodal-btn">
                                    <NavLink to="/compact_stock_form" className="first assetModal-nav"
                                    >Yes</NavLink>
                                    <NavLink to="/compact_stock_assets" className="second assetModal-nav"
...
export default CompactStockDistribute