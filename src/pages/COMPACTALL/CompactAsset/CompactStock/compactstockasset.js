...
function CompactAssetsStock() {
    ...
    return (
        <div>
            <Interface>
                <AssetInterface name="Assets" link="compact_stock_distribute" />
                    ...
                    <div className=''>
                        ...
                        <div className='bloc-design'>
                            <div className="bloc-tabs disable-bloc">
                                ...
                                <div className={toggleState === 6 ? "tabs active-tabs " : "tabs disable done"} onClick={() => toggleTab(6)}><span><img src={asset6} alt="" /></span> Investment</div>
                                <div className={toggleState === 7 ? "tabs active-tabs " : "tabs "} onClick={() => toggleTab(7)}><span><img src={asset5} alt="" /></span> Stocks</div>
                                <div className={toggleState === 8 ? "tabs active-tabs disable" : "tabs disable"} onClick={() => toggleTab(8)}><span><img src={asset6} alt="" /></span> Other Assets</div>
                            </div>
                        </div>
                        <div className='distributeAssets'>
                            <div className="content-tabs" style={{ marginTop: "40px" }}>
                                ...
                                <div className={toggleState === 7 ? "content active-content" : "content"}>
                                    ...
                                    <div className='button' style={{ textAlign: "right", paddingTop: "60px", marginTop: "30px" }}>
                                        <NavLink to="/compact_other_form" className="asset-nav1" style={{ border: "none" }}>
                                            Add Other Assets
                                        </NavLink>
                                    </div>
                                </div>
...
export default CompactAssetsStock