...
function CompactRealEstate() {
    ...
    return (
        <div>
            <Interface>
                <AssetInterface name="Assets" link="compact_realestate" />
                    ...
                    <div className=''>
                        ...
                        <div className='bloc-design'>
                            <div className="bloc-tabs disable-bloc">
                                ...
                                <div className={toggleState === 3 ? "tabs active-tabs " : "tabs"} onClick={() => toggleTab(3)}><span><img src={asset3} alt="" /></span> Real Estate</div>
                        ...
                        <div className='distributeAssets'>
                            <div className="content-tabs" style={{ marginTop: "40px" }}>
                                ...
                                <div className={toggleState === 3 ? "content active-content" : "content"}>
                                    ...
                                    <div className='button' style={{ textAlign: "right", paddingTop: "60px", marginTop: "30px" }}>
                                        <NavLink to="/compact_shares_form" className="asset-nav1" style={{ border: "none" }}>
                                            Add Shares
                                        </NavLink>
                                    </div>
