...
function CompactShowAllAsset() {
    const [toggleState, setToggleState] = useState(8);
    ...
    return (
        <div>
            <Interface>
                <AssetInterface name="Assets" link="compact_others_distribute" />
                    ...
                    <div className=''>
                        ...
                        <div className='bloc-design'>
                            <div className="bloc-tabs disable-bloc">
                                ...
                                <div className={toggleState === 7 ? "tabs active-tabs " : "tabs done"} onClick={() => toggleTab(7)}><span><img src={asset5} alt="" /></span> Stocks</div>
                                <div className={toggleState === 8 ? "tabs active-tabs " : "tabs done"} onClick={() => toggleTab(8)}><span><img src={asset6} alt="" /></span> Other Assets</div>
                            </div>
                        </div>
                        <div className='distributeAssets'>
                            <div className="content-tabs" style={{ marginTop: "40px" }}>
                                <div className={toggleState === 1 ? "content active-content" : "content"}>
                                    ...
                                    {/* <div className=''>
                                        <NavLink to="/compact_rsa_form" className="asset-nav1" style={{ border: "none" }}>
                                            Add RSA
                                        </NavLink>
                                    </div> */}
                                    ...
                                    <div className='button' style={{ textAlign: "right", paddingTop: "60px", marginTop: "30px" }}>
                                        <NavLink to="/compact_asset_success" className="asset-nav1" style={{ border: "none" }}>
                                            Complete
                                        </NavLink>
                                    </div>
                                ...
                                <div className={toggleState === 2 ? "content active-content" : "content"}>
                                    ...
                                    {/* 
                                    <div className=''>
                                        <NavLink to="/compact_cash_landing" className="asset-nav1" style={{ border: "none" }}>
                                            Add Cash in bank
                                        </NavLink>
                                    </div> */}
...
export default CompactShowAllAsset