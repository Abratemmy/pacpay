...
function CompactInvestmentDistribute() {
    ...
    return (
        <div className='Assetmain-page'>
            <Interface>
                <AssetInterface name="Distribute Assets" link="compact_investment_form" />
                        ...
                        <div className="personal-modal">
                            <div className="personal-modalContainer">
                                ...
                                <div className="personalmodal-btn">
                                    <NavLink to="/compact_investment_form" className="first assetModal-nav"
                                    >Yes</NavLink>
                                    <NavLink to="/compact_investment_assets" className="second assetModal-nav"
...
export default CompactInvestmentDistribute