...
function CompactInvestmentForm() {
    ...
    return (
        <div>
            <Interface>
                <AssetInterface name="Investment" link="compact_life_asset" />
                ...
                <MainModal trigger={beneficiary} setTrigger={setbeneficiary}>
                    <div className='modalContent'>
                        <Beneficiary submitFormLink="compact_investment_distribute" />
                    </div>
                </MainModal>
            </Interface>
        </div>
...
export default CompactInvestmentForm