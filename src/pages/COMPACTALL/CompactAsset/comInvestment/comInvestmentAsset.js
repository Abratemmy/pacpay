...
function CompactAssetsInvestment() {
    ...
    return (
        <div>
            <Interface>
                <AssetInterface name="Assets" link="compact_investment_distribute" />
                    ...
                    <div className=''>
                        ...
                        <div className='bloc-design'>
                            <div className="bloc-tabs disable-bloc">
                                ...
                                <div className={toggleState === 6 ? "tabs active-tabs" : "tabs "} onClick={() => toggleTab(6)}><span><img src={asset6} alt="" /></span> Investment</div>
                        ...
                        <div className='distributeAssets'>
                            <div className="content-tabs" style={{ marginTop: "40px" }}>
                                ...
                                <div className={toggleState === 6 ? "content active-content" : "content"}>
                                    ...
                                    <div className='button' style={{ textAlign: "right", paddingTop: "60px", marginTop: "30px" }}>
                                        <NavLink to="/compact_stock_form" className="asset-nav1" style={{ border: "none" }}>
                                            Add Stocks
                                        </NavLink>
                                    </div>
...
export default CompactAssetsInvestment