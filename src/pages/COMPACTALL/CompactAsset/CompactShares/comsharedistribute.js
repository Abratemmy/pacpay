...
function CompactSharesDistribute() {
    ...
    return (
        <div className='Assetmain-page'>
            <Interface>
                <AssetInterface name="Distribute Assets" link="compact_shares_form" />
                        ...
                        <div className="personal-modal">
                            <div className="personal-modalContainer">
                                ...
                                <div className="personalmodal-btn">
                                    <NavLink to="/compact_shares_form" className="first assetModal-nav"
                                    >Yes</NavLink>
                                    <NavLink to="/compact_share_assset" className="second assetModal-nav"
...
export default CompactSharesDistribute