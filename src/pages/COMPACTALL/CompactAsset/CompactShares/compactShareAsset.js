...
function CompactShareAsset() {
    ...
    return (
        <div>
            <Interface>
                <AssetInterface name="Assets" link="compact_share_distribute" />
                    ...
                    <div className=''>
                        ...
                        <div className='bloc-design'>
                            <div className="bloc-tabs disable-bloc">
                                ...
                                <div className={toggleState === 4 ? "tabs active-tabs " : "tabs "} onClick={() => toggleTab(4)}><span><img src={asset4} alt="" /></span> Shares</div>
                        ...
                        <div className='distributeAssets'>
                            <div className="content-tabs" style={{ marginTop: "40px" }}>
                                ...
                                <div className={toggleState === 4 ? "content active-content" : "content"}>
                                    ...
                                    <div className='button' style={{ textAlign: "right", paddingTop: "60px", marginTop: "30px" }}>
                                        <NavLink to="/compact_lifeinsurance_form" className="asset-nav1" style={{ border: "none" }}>
                                            Add Life Insurance
                                        </NavLink>
                                    </div>
...
export default CompactShareAsset