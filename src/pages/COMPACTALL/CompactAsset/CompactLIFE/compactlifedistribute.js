...
function CompactLifeDistribute() {
    ...
    return (
        <div className='Assetmain-page'>
            <Interface>
                <AssetInterface name="Distribute Assets" link="compact_lifeinsurance_form" />
                        ...
                        <div className="personal-modal">
                            <div className="personal-modalContainer">
                                ...
                                <div className="personalmodal-btn">
                                    <NavLink to="/compact_lifeinsurance_form" className="first assetModal-nav"
                                    >Yes</NavLink>
                                    <NavLink to="/compact_life_asset" className="second assetModal-nav"
...
export default CompactLifeDistribute