...
function CompactAssetsInsurance() {
    ...
    return (
        <div>
            <Interface>
                <AssetInterface name="Assets" link="compact_life_distribute" />
                    ...
                    <div className=''>
                        ...
                        <div className='bloc-design'>
                            <div className="bloc-tabs disable-bloc">
                                ...
                                <div className={toggleState === 5 ? "tabs active-tabs" : "tabs"} onClick={() => toggleTab(5)}><span><img src={asset5} alt="" /></span> Life Insurance</div>
                                ...
                                <div className={toggleState === 7 ? "tabs active-tabs disable" : "tabs disable"} onClick={() => toggleTab(7)}><span><img src={asset5} alt="" /></span> Personal</div>
                                <div className={toggleState === 8 ? "tabs active-tabs disable" : "tabs disable"} onClick={() => toggleTab(8)}><span><img src={asset6} alt="" /></span> Stocks</div>
                            </div>
                        </div>
                        <div className='distributeAssets'>
                            <div className="content-tabs" style={{ marginTop: "40px" }}>
                                ...
                                <div className={toggleState === 5 ? "content active-content" : "content"}>
                                    ...
                                    <div className='button' style={{ textAlign: "right", paddingTop: "60px", marginTop: "30px" }}>
                                        <NavLink to="/compact_investment_form" className="asset-nav1" style={{ border: "none" }}>
                                            Add Investment
                                        </NavLink>
                                    </div>
                                </div>
...
export default CompactAssetsInsurance