...
function CompactExecutorLanding() {
            ...
            <WillLanding >
                <div className='row'>
                    <div className='col-lg-5 col-md-4 col-sm-12'>
                        <NavLink to="/compact_personalinfo/1" className="navlink disable">
            ...
            <MainModal trigger={buttonpopup3} setTrigger={setbuttonpopup3}>
                <div className='modalContent'>
                    ...
                    <div className='navButtton' style={{ marginBottom: "30px" }}>
                        <NavLink to="/compact_executor_success" className="modal-nav" >Complete</NavLink>
                    </div>
...
export default CompactExecutorLanding