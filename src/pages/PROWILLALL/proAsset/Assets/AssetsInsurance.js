...
function AssetsLifeInsurance() {
    ...
    return (
        <div>
            <Interface>
                <AssetInterface name="Assets" link="pro_distribute_asset5" />
                    ...
                    <div className=''>
                        ...
                        <div className='bloc-design'>
                            <div className="bloc-tabs disable-bloc">
                                ...
                                <div className={toggleState === 7 ? "tabs active-tabs disable" : "tabs disable"} onClick={() => toggleTab(7)}><span><img src={asset3} alt="" /></span> Other Assets</div>
                            </div>
                        </div>
                        <div className='distributeAssets'>
                            <div className="content-tabs" style={{ marginTop: "40px" }}>
                                ...
                                <div className={toggleState === 5 ? "content active-content" : "content"}>
                                    ...
                                    <div className='button' style={{ textAlign: "right", paddingTop: "60px", marginTop: "30px" }}>
                                        <NavLink to="/pro_asset_investment_form" className="asset-nav1" style={{ border: "none" }}>
                                            Add Investment
                                        </NavLink>
                                    </div>
...
export default AssetsLifeInsurance