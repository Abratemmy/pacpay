...
function Prodistribute2() {
    ...
    const handleSubmit = (ev) => {
        ...
        //submit form here if no error availble
            ...
            navigate("/pro_assetcash")
        }
    }
    return (
        <div className='Assetmain-page'>
            <Interface>
                <AssetInterface name="Distribute Assets" link="pro_cash_form" />
                        ...
                        <form onSubmit={handleSubmit} style={{ position: "relative" }}>
                            ...
                            <div className='asset-btn'>
                                <div className='asset1last'>
                                    <div className='ps'>PS: You don’t want to share your asset now? you can <NavLink to="/pro_assetcash" style={{ background: "transparent", textDecoration: "none" }}><span>Skip <BsArrowUpRight className="icon" /> </span></NavLink> </div>
                        ...
                        <form>
                            <div className='input-content'>
                                <div className="form-group">
                                    <input type="checkbox" id="proCash" name="checked" />
                                    <div className='name'>
                                        <label for="proCash">Taofeeqah Bello</label>
                                        <div className='identity'><span>Female</span><span>Wife</span></div>
                                    </div>
                                </div>

                                <div className="form-group">
                                    <input type="checkbox" id="proCash2" name="checked" />
                                    <div className='name'>
                                        <label for="proCash2">Taofeeqah Bello</label>
                                        <div className='identity'><span>Female</span><span>Wife</span></div>
                                    </div>
                                </div>

                                <div className="form-group">
                                    <input type="checkbox" id="proCash3" name="checked" />
                                    <div className='name'>
                                        <label for="proCash3">Taofeeqah Bello</label>
                                        <div className='identity'><span>Female</span><span>Wife</span></div>
                                    </div>
                                </div>
                            ...
                            <div className='navButtton' style={{ marginBottom: "30px" }}>
                                <NavLink to="/pro_assetcash" className="modal-nav" >Proceed</NavLink>
                            </div>
                        </form>
                    </div>
                </MainModal>
