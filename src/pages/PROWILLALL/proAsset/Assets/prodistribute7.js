...
function Prodistribute7() {
    ...
    const handleSubmit = (ev) => {
        ...
        //submit form here if no error availble
            ...
            navigate("/pro_asset_personal")
        }
    }
    return (
        <div className='Assetmain-page'>
            <Interface>
                <AssetInterface name="Distribute Assets" link="pro_asset_personal_form" />
                        ...
                        <form onSubmit={handleSubmit} style={{ position: "relative" }}>
                            ...
                            <div className='asset-btn'>
                                <div className='asset1last'>
                                    <div className='ps'>PS: You don’t want to share your asset now? you can <NavLink to="/pro_asset_personal" style={{ background: "transparent", textDecoration: "none" }}><span>Skip <BsArrowUpRight className="icon" /> </span></NavLink> </div>
                    ...
                    <div className='modalContent'>
                        <form>
                            ...
                            <div className='navButtton' style={{ marginBottom: "30px" }}>
                                <NavLink to="/pro_asset_personal" className="modal-nav" >Proceed</NavLink>
                            </div>
                        </form>
                    </div>
                </MainModal>
