...
import { createPersonalinformationPRO } from "../../actions/auth.js"
...
function Propersonalinfo() {
    ...
    const handleSubmit = (e) => {
        ...
        if (Object.keys(burialError).length > 0) {
            ...
            dispatch(createPersonalinformationPRO(payload, navigate));
            ...
            <Interface>
                <div className="Personal-container">
                    ...
                    <div className={toggleState === 2 ? "PersonalFormcontent active-PersonalFormcontent" : "PersonalFormcontent"}>
                        <ProSpouseReview setToggleState={spouseBackBtn} reviewNext={reviewNext} addAnotherSpouse={addAnotherSpouse} spouselist={spouselist}
                            currentId={currentId} setCurrentId={setCurrentId}
                        />
                    </div>

                    <div className={toggleState === 3 ? "PersonalFormcontent active-PersonalFormcontent" : "PersonalFormcontent"}>
                        <ProChildReview setToggleState={childBackBtn} reviewNext={reviewNext} addAnotherChild={addAnotherChild} childlist={childlist} />
                    </div>
