        ...
        <div>
            ...
            <Interface>
                <div className='Personal-container container'>
                    <div className="top">
                        <span><NavLink to="/pro_personalinfo/3" className="personal-nav">
                    ...
                    <div className='Personal-list-button'>
                        <NavLink to="/pro_personalinfo/3" className="nav-link">Add another spouse</NavLink>
                    ...
                    <MainModal trigger={buttonpopup} setTrigger={setbuttonpopup}>
                        <div className='modalContent'>
                            ...
                            <div className='navButtton'>
                                <NavLink to="/pro_personalinfo/4" className="nav-link" style={{ background: "var(--blueColor)", width: "220px", margin: "auto", color: "#fff", borderRadius: "10px", padding: "8px" }}>Continue</NavLink>
                            </div>
