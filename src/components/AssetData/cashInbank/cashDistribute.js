...
function CashDistributeasset({ children, editBeneficiaryToggle }) {
    ...
    return (
        <div className='sharing-asset' >
            <div className='distributeTop'>
                ...
                <div className='right'>
                    <span to="" className="button-nav" onClick={editBeneficiaryToggle}>Edit Beneficiary</span>
                </div>
            </div>
...
export default CashDistributeasset